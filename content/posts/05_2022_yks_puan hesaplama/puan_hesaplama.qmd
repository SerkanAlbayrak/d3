...
```
Dil modeliyle ilgili gözden kaçan bir durum olduğu açık. Henüz problemin kaynağı bulunabilmiş değil. 

# Sonuç ve Tartışma

Bu yazıda hesaplanan model parametreleri ilgili puan türünde her soru grubunda yapılan bir netin kaç puana denk geldiğini göstermektedir. DİL puanının hesaplanmasına yönelik gözden kaçan bir unsur olduğu açık. Henüz çözüm getiremediğimiz için çalışan en iyi model parametreleri yazıda sunuldu. Genel olarak puan hesaplanma yöntemine yönelik tartışma yazının ikinci bölümüne ertelendi. 
