...
$$
Her üniversite için bu işlemler yapıldığında istenen bölüm[^2] bazında üniversite sıralaması elde edilmiş olur. İlk tabloya göre oldukça fazla yer değiştirmenin olduğu gözlerden kaçmayacaktır.    

[^2]: Altınbaş Ü için Hukuk'ta iki farklı bölüm var ancak ayırma zahmetine girmiyoruz.
...
Üniversitelerin kontenjanlarına yerleşen öğrencilerin puan dağılımı bilgisi paylaşılmamaktadır. Elde sadece en düşük ve en yüksek puan, arada kaç adet gözlem olduğu (yani yerleşen sayısı) ve ATLAS portalından veri çekerek elde edilen kırmızı çizgi ile gösterilen ortalama puan tahmini bulunmaktadır. Amaç bu bilgilerden yola çıkarak arka planda gri renk ile gösterilen dağılımı tahmin etmektir. 
