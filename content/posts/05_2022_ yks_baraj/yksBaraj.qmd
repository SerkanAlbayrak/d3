...
## Öğrenci Sıralamalarındaki Siyah Kutu

YKS sınav sonuçları ilk açıklandığında, üniversite öğrencisi adaylarının henüz tercihlerini kullanmadıkları ancak doğru ve yanlış yanıtlarla beraber
...
> weight = 6 kg Of course, this is just one among many possible models. Below I plot three different models, including our `weight = 6 kg` model.
