...
Bu aşamadan sonrası standard ggplot kullanmından ibaret. Geldiği şehir değişkenine göre gruplama `geom_label` içinde yapılıyor.

```{r}
#| code-fold: false
#| eval: false

ggplot(e,aes(x=`Geldiği Şehir`,
                    fill=`Kampüs Ziyareti`,
                   y=p2)) + 
  geom_bar(stat = "identity",color="black") +
  scale_y_continuous(labels=scales::percent,limits = c(0,1),
